...
const MAREF_NAV_ITEMS: {
  ...
  { id: "immunity", icon: Bug, label: "免疫系统", shortcut: "⌃4" },
  { id: "hitl", icon: UserCheck, label: "HITL 审核", shortcut: "⌃5" },
  { id: "audit", icon: FileText, label: "审计日志", shortcut: "⌃6" },
  { id: "drift", icon: BarChart3, label: "漂移检测", shortcut: "⌃7" },
