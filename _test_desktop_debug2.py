...
from maref.desktop.controller import DesktopController, ExecutionPlan, DesktopOperation, DesktopOperationType
from maref.desktop.input_controller import SafetyDecision

ctrl = DesktopController(dry_run=True)

print(f"=== Instance check ===")
...
from maref.desktop.input_controller import MouseEvent, MouseAction
