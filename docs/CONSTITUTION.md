...
跨维度自演进须满足：
- **稳定性条件**: $rac{dE}{dt} \leq 0$（Lyapunov 稳定性）
...
| 版本 | 日期 | 摘要 |
|------|------|------|
| v1.8 | 2026-09-21 | 第十条细化（外部Agent决策边界、自主决策限制、审查标准），第七条/第九条扩展（跨维度自演进约束、免疫系统约束、跨维度合规约束、跨维度数据主权约束）。 |
| v1.7 | 2026-09-17 | 第十条细化：外部Agent决策边界、自主决策限制、审查标准。 |
