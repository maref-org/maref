...
- [x] **v0.35.0-rc 审计修复** — 5 个 P0-P1 审计阻塞问题修复 / Release / Wiki / 版本一致性 / MCP 文档 / CLA 安装
...
- [x] **GitHub Wiki 补全** — 架构说明、快速开始、API 参考链接
- [x] **Release v0.35.0-rc 发布** — 首次 GitHub Release + 版本标签
- [x] **版本一致性锁** — Dockerfile / pyproject.toml / Cargo.toml / package.json 版本统一
- [x] **MCP/A2A 端点公开文档化** — `docs/api.md` 补充 MCP 端点
- [ ] **GitHub Projects 补全** — Roadmap / Milestone / Issue 模板 (需 project scope token)
- [ ] **CI workflow 修复** — `ci.yml` YAML 解析错误修复待推送 (需 workflow scope token)

### P1 — 社区生态

- [x] **README 升级** — 添加 Loop Engineering 叙事、5 行集成示例、治理对比矩阵
- [x] **CONTRIBUTING.md** — PR 流程、CLA 签署、开发环境搭建（已存在）
- [x] **Issue 模板** — bug / feature / question 三类模板（已存在）
- [ ] **SSH 签名密钥配置** — 维护者签名验证
