...
class TestEdgeCases:
    ...
    def test_long_code_performance(self, checker):
        code_lines = [
            f'x_{i} = requests.get(url, verify=False)\n' for i in range(1000)
        ]
