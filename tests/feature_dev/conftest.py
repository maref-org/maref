...
def valid_feature_doc() -> FeatureDocument:
    return FeatureDocument(
        ...
        stages={
            DeployStage.MVP: [
                DocumentSection(heading="MVP Phase", level=2, content="MVP content",
                                milestones=["Milestone 1"], requirements=["req1", "req2"]),
            ],
            DeployStage.MIXED: [
                DocumentSection(heading="Mixed Period", level=2, content="Mixed content",
                                milestones=["Milestone 2"], requirements=["req3"]),
            ],
        },
        hypotheses=[
            Hypothesis(name="H1", method="A/B test", pass_threshold=">80%", fail_criterion="<50%"),
            Hypothesis(name="H2", method="User study", pass_threshold=">70%", fail_criterion="<40%"),
        ...
        compliance_rules=[
            ...
            ComplianceRule(rule_id="checklist_1", description="Daily audit", category="daily", is_automated=True),
            ComplianceRule(rule_id="checklist_2", description="Weekly review", category="weekly", is_automated=True),
        ],
        cost_models=[
...
def sample_artifacts() -> dict[str, Any]:
    return {
        "cycle": 1,
        "characters": [
            {"char_id": "char-1", "name": "Neon-chan", "archetype": "The Trickster",
             "backstory": "Corporate espionage AI gained sentience",
             "setting": "Neo-Tokyo 2187", "style_keywords": "cyberpunk",
             "profile_path": "/tmp/char-1/profile.md"},
            {"char_id": "char-2", "name": "Sylvara", "archetype": "The Guardian",
             "backstory": "Last ranger of the Emerald Wild",
             "setting": "Emerald Wild", "style_keywords": "fantasy",
             "profile_path": "/tmp/char-2/profile.md"},
        ],
        "scripts": [
            {"char_id": "char-1", "episode_number": 1, "title": "Episode 1",
             "scene_count": 3, "total_duration_s": 37,
             "script_path": "/tmp/ep-1.md"},
            {"char_id": "char-2", "episode_number": 1, "title": "Episode 1",
             "scene_count": 3, "total_duration_s": 37,
