...
class ChainRiskAnalyzer:
    ...
    def analyze(self, chain: DelegationChain, boundary_manager: TrustBoundaryManager | None = None) -> list[ChainRiskFactor]:
        """分析委托链风险"""
        risks = []
...
class IntegratedTrustEngine:
    ...
    def __init__(
        ...
        chain_analyzer: ChainRiskAnalyzer | None = None
    ):
    ...
    def generate_combined_report(self, agent_id: str, chain: DelegationChain | None = None) -> dict[str, Any]:
        """生成综合信任报告"""
