...
ERROR_HTTP_MAP: dict[ErrorCode, int] = {
    ...
    ErrorCode.GOVERNANCE_REJECTED: 403,
    ErrorCode.SAFETY_GATE_BLOCKED: 403,
    ErrorCode.CIRCUIT_BREAKER_OPEN: 503,
    ErrorCode.TRUST_CHAIN_BROKEN: 403,
    ErrorCode.BOUNDARY_VIOLATION: 403,
    ErrorCode.TRANSITION_INVALID: 400,
    ErrorCode.EVOLUTION_FAILED: 500,
    ErrorCode.OBSERVATION_FAILED: 500,
    ErrorCode.MCP_ERROR: 502,
    ErrorCode.A2A_ERROR: 502,
}
...
class MAREFError(Exception):
    ...
    @classmethod
    def from_exception(
        cls, exc: Exception, code: ErrorCode = ErrorCode.INTERNAL_ERROR
    ) -> MAREFError:
