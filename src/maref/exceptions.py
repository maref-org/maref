...
class ErrorCode(str, Enum):
    ...
    BOUNDARY_VIOLATION = 'E1006'
    TRANSITION_INVALID = 'E2001'
    EVOLUTION_FAILED = 'E2002'
    OBSERVATION_FAILED = 'E3001'
    MCP_ERROR = 'E4001'
    A2A_ERROR = 'E4002'
ERROR_HTTP_MAP: dict[ErrorCode, int] = {ErrorCode.UNKNOWN: 500, ErrorCode.NOT_FOUND: 404, ErrorCode.VALIDATION_ERROR: 400, ErrorCode.PERMISSION_DENIED: 403, ErrorCode.RATE_LIMITED: 429, ErrorCode.INTERNAL_ERROR: 500, ErrorCode.NOT_IMPLEMENTED: 501, ErrorCode.CONFLICT: 409, ErrorCode.UNAUTHORIZED: 401, ErrorCode.QUOTA_EXCEEDED: 429, ErrorCode.SANDBOX_VIOLATION: 403, ErrorCode.GOVERNANCE_REJECTED: 403, ErrorCode.SAFETY_GATE_BLOCKED: 403, ErrorCode.CIRCUIT_BREAKER_OPEN: 503, ErrorCode.TRUST_CHAIN_BROKEN: 403, ErrorCode.BOUNDARY_VIOLATION: 403, ErrorCode.TRANSITION_INVALID: 400, ErrorCode.EVOLUTION_FAILED: 500, ErrorCode.OBSERVATION_FAILED: 500, ErrorCode.MCP_ERROR: 502, ErrorCode.A2A_ERROR: 502}
