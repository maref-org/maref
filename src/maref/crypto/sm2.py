...
class SM2KeyPair:
    ...
    def generate(cls) -> SM2KeyPair:
        ...
        """
        # 生成 32 字节随机私钥，加上 00 前缀符合 gmssl 格式
...
def _derive_public_key(private_key: str) -> str:
    ...
    _b = 0x28E9FA9E_9D9F5E34_4D5A9E4B_CF6509A7_F39789F5_15AB8F92_DDBCBD41_4D940E93  # noqa: F841
