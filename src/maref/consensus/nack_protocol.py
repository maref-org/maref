...
DEFAULT_RECOVERABILITY: dict[NackCode, Recoverability] = {
    NackCode.TRUST_TOO_LOW: Recoverability.REROUTE,
    NackCode.SAFETY_GATE_BLOCKED: Recoverability.ABORT,
    NackCode.CAPABILITY_MISMATCH: Recoverability.REROUTE,
    NackCode.OVERLOADED: Recoverability.RETRY,
    NackCode.QUOTA_EXHAUSTED: Recoverability.REROUTE,
    NackCode.LEASE_CONFLICT: Recoverability.RETRY,
    NackCode.TIMEOUT: Recoverability.RETRY,
    NackCode.DEADLINE_VIOLATION: Recoverability.ESCALATE,
    NackCode.INVALID_CONTEXT: Recoverability.ABORT,
    NackCode.VERSION_MISMATCH: Recoverability.ESCALATE,
    NackCode.SCHEMA_VIOLATION: Recoverability.ABORT,
    NackCode.ETHICAL_OBJECTION: Recoverability.ESCALATE,
    NackCode.HUMAN_IN_THE_LOOP_REQUIRED: Recoverability.ESCALATE,
    NackCode.UNSPECIFIED: Recoverability.ABORT,
}
...
class NackMessage:
    ...
    def to_dict(self) -> dict[str, Any]:
        return {
            ...
            "suggested_alternative_agents": list(self.suggested_alternative_agents),
...
class NackBuilder:
    ...
    def build(self) -> NackMessage:
        ...
        return NackMessage(
            ...
            suggested_alternative_agents=self._alternatives,
