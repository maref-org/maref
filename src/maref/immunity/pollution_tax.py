...
if _OTEL_AVAILABLE:
    ...
    _pollution_counter = _meter.create_counter(
        "maref.pollution_tax.applied", unit="1", description="Number of pollution tax applications"
    )
    ...
    _downgrade_counter = _meter.create_counter(
        "maref.pollution_tax.downgrade", unit="1", description="Number of credit rating downgrades"
    )
    _tax_multiplier_gauge = _meter.create_gauge(
        "maref.pollution_tax.multiplier", unit="1", description="Current generation tax multiplier"
    )
