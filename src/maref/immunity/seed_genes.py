    ...
    genes: list[NegativeGene] = [
        ...
        NegativeGene(
            ...
            patterns=[
                ...
                GenePattern(
                    "", "", "regex", r"cryptography\.hazmat\.primitives\.ciphers\.algorithms\.ARC4"
                ),
            ],
        ),
        NegativeGene(
...
def _seed_curl_fakes(bank: NegativeGeneBank) -> int:
    ...
    genes: list[NegativeGene] = [
        ...
        NegativeGene(
            ...
            patterns=[
                GenePattern(
                    "", "", "regex", r"##\s*(Impact|PoC|POC|Proof of Concept|Suggested Fix)"
                ),
            ],
        ),
        NegativeGene(
...
def _seed_supply_chain(bank: NegativeGeneBank) -> int:
    ...
    genes: list[NegativeGene] = [
        ...
        NegativeGene(
            ...
            patterns=[
                GenePattern(
                    "", "", "regex", r"assert\s+\w+\.(is_authenticated|has_permission|role)"
                ),
            ],
        ),
        NegativeGene(
...
def _seed_stackoverflow(bank: NegativeGeneBank) -> int:
    ...
    genes: list[NegativeGene] = [
        NegativeGene(
            ...
            patterns=[
                GenePattern(
                    "", "", "regex", r"TypeError:.*missing \d+ required positional argument"
                ),
            ],
        ),
        NegativeGene(
        ...
        NegativeGene(
            ...
            patterns=[
                GenePattern(
                    "", "", "regex", r"import.*\b(core_utils|ml_helpers|ai_tools|utils_common)\b"
                ),
            ],
        ),
        NegativeGene(
...
def _seed_javascript_patterns(bank: NegativeGeneBank) -> int:
    ...
    genes: list[NegativeGene] = [
        ...
        NegativeGene(
            ...
            patterns=[
                GenePattern(
                    "", "", "regex", r"npm\s+install\s+(underscore|gulp|request|moment|bower)"
                ),
            ],
        ),
        # Crypto misuse
        ...
        NegativeGene(
            ...
            patterns=[
                GenePattern(
                    "", "", "regex", r"res\.redirect\(.*req\.query\.(url|redirect|next|return)"
                ),
...
def _seed_more_stackoverflow(bank: NegativeGeneBank) -> int:
    ...
    genes: list[NegativeGene] = [
        ...
        NegativeGene(
            ...
            patterns=[
                GenePattern(
                    "", "", "regex", r"TypeError: '.*' object doesn't support item assignment"
                ),
            ],
        ),
        NegativeGene(
...
_BULK_ENTRIES: list[tuple[str, str, str, int, list[str]]] = [
    ...
    ("CWE-79", "XSS via Vue v-html", "vue", 9, [r"v-html\s*="]),
    ("CWE-79", "XSS via Svelte @html", "svelte", 9, [r"\{@html\s+\w+"]),
    (
        "CWE-79",
    ...
    ("CWE-79", "XSS via JSP out.print", "jsp", 10, [r"out\.print(ln)?\(.*request\.getParameter"]),
    ("CWE-79", "XSS via Go template.HTML", "go", 10, [r"template\.HTML\(.*(request|r\.FormValue)"]),
    ("CWE-79", "XSS via Flask |safe filter", "py", 9, [r"\{\{.*\|safe\}", r"Markup\(.*request"]),
    ("CWE-79", "XSS via echo no escape", "php", 10, [r"echo\s+\$_", r"print\s+\$_"]),
    (
        "CWE-89",
    ...
    ("CWE-295", "SSL verify disabled", "go", 9, [r"InsecureSkipVerify:\s*true"]),
    ("CWE-295", "SSL verify disabled", "rs", 9, [r"danger_accept_invalid_certs\(true\)"]),
    (
        "CWE-312",
        "Secret in logs",
        "py",
    ...
    ("CWE-312", "Secret in logs", "js", 9, [r"console\.log\(.*(req\.body|password|token)"]),
    (
        "CWE-312",
        "Secret in logs",
        "java",
    ...
    ("CWE-326", "Weak crypto MD5", "py", 7, [r"hashlib\.md5\(.*(pass|token|secret)"]),
    ...
    ("CWE-326", "Weak crypto MD5", "go", 7, [r"md5\.Sum\(\[\]byte\(.*pass"]),
    ("CWE-326", "Weak crypto ECB", "java", 7, ["AES/ECB", "Cipher\\.getInstance\\([\"']AES[\"']"]),
    ("CWE-326", "Weak crypto ECB", "cs", 7, [r"CipherMode\.ECB"]),
    ("CWE-400", "DoS no pagination", "py", 6, [r"\.all\(\)"]),
    ("CWE-400", "DoS no body limit", "js", 5, [r"express\.json\(\)"]),
    ("CWE-434", "Unrestricted file upload", "py", 8, [r"file\.save\(.*request", "uploaded_file"]),
    ("CWE-434", "Unrestricted file upload", "js", 8, [r"multer\(\)", r"req\.file\.path"]),
    ("CWE-434", "Unrestricted file upload", "php", 8, [r"move_uploaded_file\(.*\$_FILES"]),
    (
        "CWE-502",
    ...
    ("CWE-502", "Unsafe deserialize YAML", "py", 9, [r"yaml\.load\(.*(Loader|open)"]),
    (
        "CWE-502",
    ...
    ("CWE-502", "Unsafe deserialize SnakeYAML", "java", 9, [r"Yaml\(\)\.load\(.*(request|body)"]),
    ("CWE-502", "Unsafe deserialize gob", "go", 9, [r"gob\.NewDecoder\(.*(request|r\.Body)"]),
    ("CWE-502", "Unsafe deserialize unserialize", "php", 10, [r"unserialize\(\$_"]),
    (
        "CWE-611",
        "XXE via XML parser",
        "py",
    ...
    ("CWE-611", "XXE via XML parser", "cs", 8, [r"new XmlDocument\(\)"]),
    (
        "CWE-798",
        "Hardcoded API key",
        "py",
    ...
    ("CWE-862", "Missing auth check", "go", 8, [r"mux\.HandleFunc", r"http\.HandleFunc"]),
    ("CWE-918", "SSRF via user URL", "py", 8, [r"requests\.(get|post)\(.*(request|url)"]),
    (
        "CWE-918",
        "SSRF via user URL",
        "js",
    ...
    ("CWE-918", "SSRF via user URL", "go", 8, [r"http\.(Get|Post)\(.*request"]),
    ("CWE-918", "SSRF via user URL", "cs", 8, [r"HttpClient.*(Get|Post)Async\(.*request"]),
    ("CWE-20", "Missing input validation", "py", 7, [r"int\(request\.(GET|POST)\["]),
    ("CWE-20", "Missing input validation", "js", 7, [r"parseInt\(req\.(query|params)"]),
    ("CWE-77", "Command injection via pipe", "py", 9, [r"subprocess.*\|"]),
    ("CWE-77", "Command injection via &&", "java", 9, [r"Runtime\.exec\(.*(&&|;)"]),
    ("CWE-79", "XSS via jQuery append", "js", 7, [r"\$\(.*\)\.(append|prepend)\(.*request"]),
    ("CWE-79", "XSS via Thymeleaf utext", "java", 8, [r"th:utext\s*="]),
    ("CWE-79", "XSS via Blade !! !!", "php", 9, [r"\{!!.*\$"]),
    ("CWE-79", "XSS via Django safe filter", "py", 9, [r"\{\{.*\|safe\}", r"Markup\(.*request"]),
    ("CWE-89", "SQLi via SQLAlchemy text()", "py", 9, ["text\\(f[\"'].*SELECT"]),
    ("CWE-89", "SQLi via TypeORM raw SQL", "ts", 10, [r"query\(`SELECT.*WHERE.*\$\{"]),
    ("CWE-89", "SQLi via MyBatis $ {}", "xml", 9, [r"\$\{.*\}"]),
    ("CWE-89", "SQLi via Prisma queryRaw", "ts", 10, [r"prisma\.\$queryRaw\(`.*\$\{"]),
    (
        "CWE-89",
    ...
    ("CWE-120", "Buffer overflow via sprintf %s", "c", 9, [r"sprintf\(.*%s.*(user|input)"]),
    ("CWE-122", "Heap overflow via calloc", "c", 9, [r"calloc\(.*(user|input)"]),
    ("CWE-190", "Integer overflow unchecked", "c", 6, [r"int\s+\w+\s*=\s*\w+\s*\+\s*\w+"]),
    ("CWE-269", "Missing privilege drop", "py", 8, ["drop_privileges", "setuid"]),
    ("CWE-276", "World-writable temp file", "py", 6, [r"tempfile\.mktemp\("]),
    ("CWE-287", "Auth bypass client-side", "js", 8, ["user\\.role\\s*===\\s*['\"]admin['\"]"]),
    ("CWE-287", "Token in URL", "py", 8, ["token\\s*=\\s*[\"'].*\\?token"]),
    ("CWE-287", "Auth bypass via !isAdmin!", "js", 8, ["!isAdmin", r"isAdmin\s*=\s*true"]),
    (
        "CWE-295",
        "SSL verify disabled",
        "java",
    ...
    ("CWE-326", "Weak crypto SHA1", "go", 7, [r"sha1\.Sum\(\[\]byte\(.*pass"]),
    ("CWE-326", "Weak crypto SHA1", "py", 7, [r"hashlib\.sha1\(.*(pass|token)"]),
    ("CWE-326", "Weak crypto bcrypt < 12", "py", 7, [r"bcrypt\.gensalt\(.*rounds\s*<\s*12"]),
    ...
    ("CWE-400", "unbounded read", "py", 6, [r"\.read\(\)"]),
    ("CWE-476", "Null dereference after malloc", "c", 6, [r"malloc\(.*\).*->"]),
    ("CWE-502", "Unsafe pickle.load", "py", 10, [r"pickle\.load\(open\("]),
    ("CWE-502", "Unsafe yaml.load no safe", "py", 9, [r"yaml\.load\(stream"]),
    ("CWE-502", "Unsafe jsonpickle decode", "py", 9, [r"jsonpickle\.(decode|loads)\("]),
    ("CWE-611", "XXE lxml parser", "py", 8, [r"lxml\.etree\.parse\(.*resolve_entities"]),
    ("CWE-676", "tmpfile race condition", "c", 8, [r"(tmpfile|mktemp)\("]),
    ("CWE-770", "No file size limit upload", "py", 6, [r"file\.read\(\)"]),
    ("CWE-770", "Allocation without limit", "py", 6, [r"request\.get\(.*\.content"]),
    (
        "CWE-798",
    ...
    ("CWE-798", "Hardcoded API key", "java", 10, [r"String\s+\w*API_KEY\w*"]),
    ("CWE-798", "Hardcoded DB password", "xml", 9, [r"jdbc:mysql.*password\s*=\s*\w+"]),
    ("CWE-862", "Missing auth in route", "py", 8, ["@app\\.route.*\n(?!.*@login)"]),
    ("CWE-918", "SSRF via requests lib", "py", 8, [r"requests\.(get|post)\(.*url"]),
    ("CWE-20", "No input sanitization in Flask", "py", 7, [r"request\.(GET|POST)\[.*\].*\)"]),
    ("CWE-78", "Command injection Node execSync", "js", 10, ["execSync\\([\"'].*\\+.*req"]),
    ("CWE-79", "XSS via innerHTML innerJS", "js", 10, [r"\.innerHTML\s*=\s*"]),
    ("CWE-79", "XSS via window.open url", "js", 7, [r"window\.open\(.*request"]),
    ...
    ("CWE-94", "Code injection via compile()", "py", 10, [r"compile\(.*(request|input)"]),
    ("CWE-94", "Code injection via execScript", "php", 10, [r"preg_replace\(.*\/e"]),
    ("CWE-120", "Stack buffer strncpy misuse", "c", 8, [r"strncpy\(.*sizeof"]),
    ("CWE-190", "Integer overflow via user input", "py", 6, [r"int\(request"]),
    ("CWE-200", "Info leak stack trace", "py", 6, [r"traceback\.print_exc\("]),
    ("CWE-200", "Info leak stack trace", "js", 6, [r"console\.error\(err"]),
    ("CWE-276", "Default permissive CORS", "js", 6, [r"Access-Control-Allow-Origin:\s*\*"]),
    ("CWE-287", "Role check client-side", "js", 8, [r"localStorage\.getItem\(.*role"]),
    ("CWE-295", "TLS verify disabled Python", "py", 9, [r"CHECK_HOSTNAME\s*=\s*False"]),
    ("CWE-295", "TLS verify disabled Node", "js", 9, [r"rejectUnauthorized:\s*false"]),
    ("CWE-295", "TLS verify disabled Java", "java", 9, ["setDefaultSSLSocketFactory.*TrustAll"]),
    ("CWE-312", "Session token in URL", "js", 9, [r"session.*token.*request\.query"]),
    ("CWE-326", "Weak password hashing SHA256", "py", 7, [r"sha256\(.*(password|passwd)"]),
    ...
    ("CWE-400", "No pagination ORM all()", "py", 6, [r"\.all\(\)"]),
    ("CWE-400", "Large file read into memory", "py", 6, [r"open\(.*\).*read\(\)"]),
    ("CWE-434", "Upload no size check", "js", 8, [r"req\.file"]),
    ("CWE-476", "Null check missing", "js", 6, [r"\w+\.length"]),
    ("CWE-502", "Unmarshal untrusted JSON Go", "go", 9, [r"json\.Unmarshal\(.*r\.Body"]),
    ("CWE-502", "Deserialize XML Java", "java", 10, [r"XMLDecoder\(.*request"]),
    ("CWE-502", "Deserialize Snappy Go", "go", 9, [r"snappy\.Decode\(.*request"]),
    ("CWE-601", "Open redirect Express next", "js", 7, [r"res\.redirect\(.*req\.query\.next"]),
    ("CWE-611", "XXE Java SAXBuilder", "java", 8, ["SAXBuilder"]),
    ("CWE-676", "mktemp insecure C", "c", 8, [r"mktemp\("]),
    ("CWE-798", "Hardcoded password Java String", "java", 9, [r"String\s+\w*(pass|pwd)"]),
]
