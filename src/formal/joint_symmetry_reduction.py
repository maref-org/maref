...
ALL_INVARIANTS = [
    check_halt_implies_agents_dead,
    check_stabilize_implies_no_conflict,
    check_act_implies_executing,
    check_halt_gov_absorbing,
    check_zombie_implies_gov_analyzed,
    check_terminated_immutability,
    check_halt_joint_absorbing,
]
