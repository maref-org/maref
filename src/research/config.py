...
__all__ = ['get_project_root', 'get_mailbox_dir', 'get_output_dir', 'get_research_output_dir', 'get_log_dir', 'get_knowledge_graph_path', 'ENV_PROJECT_ROOT', 'ENV_MAILBOX_DIR', 'ENV_OUTPUT_DIR', 'ENV_RESEARCH_OUTPUT', 'ENV_DASHSCOPE_API_KEY']
